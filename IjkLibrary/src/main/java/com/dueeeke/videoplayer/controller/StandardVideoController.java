...
//        moreMenu.setOnClickListener(this);
        ...
        ijkTitle = (TextView) controllerView.findViewById(R.id.ijk_controls_title);
        ijkControlSize = (TextView) controllerView.findViewById(R.id.ijk_controls_size);
        ...
        title = (MarqueeTextView) controllerView.findViewById(R.id.title);
        sysTime = (TextView) controllerView.findViewById(R.id.sys_time);
        batteryLevel = (ImageView) controllerView.findViewById(R.id.iv_battery);
