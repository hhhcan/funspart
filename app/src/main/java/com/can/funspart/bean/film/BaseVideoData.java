...
public class BaseVideoData implements Parcelable {
    ...
    public BaseVideoData fromCursor(Cursor cursor) {
    ...
    protected BaseVideoData(Parcel in) {
    ...
    public static final Creator<BaseVideoData> CREATOR = new Creator<BaseVideoData>() {
        @Override
        public BaseVideoData createFromParcel(Parcel source) {
            return new BaseVideoData(source);
        }

        @Override
        public BaseVideoData[] newArray(int size) {
            return new BaseVideoData[size];
        }
    };
}
