...
import com.can.mc.cyg.cygptr.PtrUIHandler;
import com.can.mc.cyg.cygptr.indicator.PtrIndicator;
import com.can.mc.cyg.cygptr.indicator.PtrTensionIndicator;
...
//        iv_refresh.setColorFilter(ThemeUtils.getThemeColor());
        progressbar_pull = (ProgressBar) view.findViewById(R.id.progressbar_pull);
        //根据主题动态适配加载进度圆形图片
        progressbar_pull.setIndeterminateTintMode(PorterDuff.Mode.SRC_ATOP);
        progressbar_pull.setIndeterminateTintList(ThemeUtils.getNaviItemIconTinkList());
        tv_pull_title = (TextView) view.findViewById(R.id.tv_pull_title);
        progressbar_pull.setVisibility(GONE);
